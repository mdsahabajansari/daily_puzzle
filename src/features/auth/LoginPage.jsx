        ...
        >
            <div className="glass p-10 space-y-10">
                <div className="text-center space-y-3">
                    ...
                    <h2 className="text-3xl font-black tracking-tighter text-gradient">WELCOME BACK</h2>
                ...
                <div className="space-y-4">
                    <motion.button
                        ...
                        className="w-full py-4 px-6 rounded-2xl bg-white text-gray-950 font-black text-xs uppercase tracking-widest flex items-center justify-center gap-4 hover:shadow-xl transition-all"
                    >
                    ...
                    <motion.button
                        ...
                        className="w-full py-4 px-6 rounded-2xl bg-[#0099FF] text-white font-black text-xs uppercase tracking-widest flex items-center justify-center gap-4 hover:shadow-xl shadow-lg shadow-[#0099FF]/20 transition-all"
                    >
                        📱 Biometric Sync
                    </motion.button>
                </div>
